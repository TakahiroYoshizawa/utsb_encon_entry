...
* このシステムの整備
  ...
  * あとは，いくつかの変更点を変更します，（詳しくは手順書を読みましょう）
...
詳しい１つ１つの機能がどのように実装されているかについては,それぞれのファイルに詳細を記載しております．そちらを読んでください．
ですが基本的にあなたがすることは，基本的にコピー&ペーストです！


# このフォルダについて
このフォルダは，以下のような構成になっています，１つ１つの機能ごとにフォルダと，README.md(説明書)がついてます．
```sh
utsb_encon_entry  
├── README.md #このファイル!!
